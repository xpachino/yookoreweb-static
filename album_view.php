...
<div class="mp-view-header">
    <div style="padding:0px 0px;">
    	<span style="font-size:22px; font-weight:700;"><span><img style="margin-right:7px;" src="img/icons/photox.png" width="30"></span>Echo Album Name</span>
        <div style="padding:10px 0 0 0;">
        	<a href="my_photos.php"><span><img style="margin-right:4px;" src="img/icons/photo.png" width="12"></span>Back to Album</a> · <a href="#"><span><img style="margin-right:4px;" src="img/icons/photo-grey.png" width="14"></span>Add Photos</a> · <a href="#"><span><img style="margin-right:4px;" src="img/icons/video.png" width="14"></span>Add Video</a>
        </div>
    </div>
</div>
<!--mp-view-header ends-->
