...
<!--left column-->
     ...
     <!--user details-->
        ...
        <div class="list-group">
            <a href="#" class="list-group-item active"><span class="list-group-icons"><img src="img/icons/blogs.png" width="18"></span>Albums</a>
            <a href="#" class="list-group-item"><span class="list-group-icons"><img src="img/icons/profile.png" width="18"></span> Photos of You</a>
            <a href="#" class="list-group-item"><span class="list-group-icons"><img src="img/icons/photo.png" width="18"></span>Your Photos</a>
        </div>
        </div> 
...
<div class="mp-view-header">
    <div style="padding:0px 0px;">
        ...
        <div style="padding:10px 0 0 0;">
        	<a href="#"><span><img style="margin-right:4px;" src="img/icons/photo.png" width="12"></span>Create Album · <span><img style="margin-right:4px;" src="img/icons/photo-grey.png" width="14"></span>Add Photos · <span><img style="margin-right:4px;" src="img/icons/video.png" width="14"></span>Add Video</a>
        </div>
    </div>
</div>
<!--mp-view-header ends-->
...
<div class="row">
   <div class="col-sm-6 col-md-3 mp-less-pad">
      <div class="thumbnail">
         <img src="img/people/guy-1.jpg">
      </div>
      <div class="caption"> 
            <a href="#" class="btn btn-default photo-btn" role="button">
               Welcome Party
            </a>
      </div>
   </div>
