        ...
        <ul class="nav nav-tabs" role="tablist" id="myTab">
          <li role="presentation"><a href="#main" aria-controls="main" role="tab" data-toggle="tab"><span class="status-update-icon-active"><img src="img/icons/status-blue.png" width="12" ></span>Post</a></li>
