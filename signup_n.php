...
<body style="background:#069!important;">
<?php require("includes/header.php") ?>
<!--content body starts-->
<div class="container" style="padding:0 20px;">
<div class="margin-overide">
	<div class="onboard-wrapper">
    	<h1>Set Up Your Account - Step 1</h1>
        <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12 offset-padding add-margin-bottom">
        	<div class="upload-profile-pix"></div>
            <div class="form-group">
                <label for="exampleInputFile">Upload Photo</label>
                <input type="file" id="exampleInputFile">
            </div>
        </div>
        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 offset-padding" style="float:right;">
		...
		Tell us about all the stuff you love and we’ll help you get set up.
           ...
           <div class="field50-wrap">
            	<div class="field50-left"><button type="submit" class="btn btn-signup">Continue</button></div>
                <div class="field50-right"><button type="submit" class="btn add-photo-button">Skip this step</button></div>
            	<div class="clear"></div>
            </div>
        </div>
    <div class="clear"></div>
